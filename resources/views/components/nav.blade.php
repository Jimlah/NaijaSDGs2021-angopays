<div class="static z-50 flex flex-col items-center justify-between w-full h-full py-5 bg-purple-900">
    ...
    <div class="flex flex-col w-10/12 space-y-10">
        <div class="flex items-center">
            ...
            <span class="font-bold text-blue-600">AngoPays</span>
        </div>
    ...
    <div class="flex flex-col items-center w-10/12 px-2 py-2 space-y-2 rounded-lg bg-blue-50">
        ...
        <a href={{ route('transactions.create') }} class="w-full py-2 font-bold text-center text-blue-600 bg-white rounded-lg hover:bg-gray-200">Create
            File</a>
    </div>
</div>
